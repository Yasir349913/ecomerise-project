...
export default function AgentJournal({ searchQuery = "" }) {
  ...
  return (
    <div className="w-full px-3.5 md:pl-3.5 md:pr-6 pt-6 font-['Plus_Jakarta_Sans',sans-serif]">
      {/* Header */}
      <div className="mb-6 md:mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-[22px] sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-none text-[#464255] mb-2">
              Agent Journal
            </h1>
            <p className="text-xs sm:text-sm md:text-base leading-none text-[#464255]">
              Helps you to see the last issues in your store.
            </p>
          </div>
          <div className="flex items-center gap-2 bg-[#F7F7F7] px-3 sm:px-4 py-1.5 sm:py-2 rounded-full">
          ...
          <div className="md:hidden mb-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-[#F7F7F7] rounded-full text-sm border-none outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
        )}
      ...
      <ul className="md:hidden space-y-3">
        {filteredEntries.map((entry) => (
          ...
          >
            ...
            <p className="text-sm text-gray-900 mt-2">{entry.message}</p>
      ...
      {/* ------- Desktop: Table ------- */}
      <div className="hidden md:block w-full rounded-xl overflow-hidden bg-white shadow-sm">
